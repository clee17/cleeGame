            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                scope.toggleEditor = function(enabled){
                    if (tinyInstance &&
                        ...
                        tinyInstance.getBody().setAttribute('contenteditable',enabled);
                        tinyInstance.getBody().style.background = enabled? 'white':'rgba(185,185,185,0.8)';
                        let buttonsAPI = tinyInstance.ui.registry.getAll().buttonsApi;
