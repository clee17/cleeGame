app.directive('infoReceiver',function($cookies,$rootScope){
    return {
        restrict: 'E',
...
app.directive('feedbackContent',function($cookies){
    return {
        restrict: 'E',
        link:function(scope,element,attr){
...
app.controller("feedbackCon",function($scope,$rootScope,$cookies,$http,$timeout,$window,feedbackManager){
